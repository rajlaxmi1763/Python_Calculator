...
IFontDisp = Font
__all__ = [ 'OLE_YPOS_PIXELS', 'FONTSTRIKETHROUGH', 'OLE_HANDLE',
           'IFontEventsDisp', 'Unchecked', 'Checked',
           'OLE_XPOS_PIXELS', 'OLE_XSIZE_PIXELS', 'Monochrome',
           'OLE_XSIZE_HIMETRIC', 'FONTNAME', 'Font', 'FontEvents',
           'OLE_TRISTATE', 'IPictureDisp', 'LoadPictureConstants',
           'OLE_CANCELBOOL', 'IFontDisp', 'OLE_XPOS_CONTAINER',
           'FONTSIZE', 'Gray', 'Default', 'OLE_ENABLEDEFAULTBOOL',
           'FONTITALIC', 'OLE_YSIZE_HIMETRIC', 'IPicture',
           'OLE_YPOS_CONTAINER', 'OLE_COLOR', 'FONTUNDERSCORE',
           'Color', 'FONTBOLD', 'OLE_OPTEXCLUSIVE', 'StdPicture',
           'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_PIXELS', 'StdFont',
           'Picture', 'IFont', 'VgaColor', 'OLE_YPOS_HIMETRIC',
